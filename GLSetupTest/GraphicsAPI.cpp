...
namespace JLEngine
{
	...
	void GraphicsAPI::CreateShaderFromFile(ShaderProgram* program)
	{
	...
	void GraphicsAPI::CreateShaderFromText(ShaderProgram* program, std::vector<std::string> shaderTexts)
	{
		auto shaders = program->GetShaders();
	...
	void GraphicsAPI::DisposeShader(ShaderProgram* program)
	{
	...
	bool GraphicsAPI::CreateRenderTarget( RenderTarget* target )
	{
	...
	bool GraphicsAPI::ResizeRenderTarget(RenderTarget* target, int newWidth, int newHeight)
	{
	...
	void GraphicsAPI::DisposeRenderTarget( RenderTarget* target )
	{
