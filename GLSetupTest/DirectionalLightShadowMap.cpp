...
namespace JLEngine
{
    ...
    void DirectionalLightShadowMap::ShadowMapPassSetup(const glm::mat4& lightView, const glm::mat4& lightProjection)
    {
        ...
        m_shadowMapShader->SetUniform("u_LightView", lightView);
        m_shadowMapShader->SetUniform("u_LightProjection", lightProjection);
    }
}